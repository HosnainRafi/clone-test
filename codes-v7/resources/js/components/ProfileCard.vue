    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      >
        <div class="relative drop-shadow-2">
          ...
          <label
            for="profile"
            class="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-80 sm:bottom-2 sm:right-2"
          >
            <svg
              class="fill-current"
              width="14"

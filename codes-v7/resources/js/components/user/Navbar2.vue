...
const mainNavItems: RouteProps[] = [
  ...
  },
  {
    ...
    label: "About",
    children: [
      { href: "/about-mbstu", label: "About MBSTU" },
      { href: "/about-mawlana-bhashani", label: "About Mawlana Bhashani" },
      { href: "/overview", label: "Overview" },
      { href: "/vision-mission", label: "Vision & Mission" },
      { href: "/achievements", label: "Achievements" },
      { href: "/university-facts-acts", label: "University Facts & Acts" },
      { href: "/location-maps-and-direction", label: "Location, Maps and Direction" },
      { href: "/visit-mbstu", label: "Visit MBSTU" },
    ]
  },
  {
    href: "#academics",
    ...
    children: [
      ...
      { href: "/academics-detail", label: "Undergraduate Programs" },
      { href: "/graduate", label: "Graduate Programs" },
  ...
  },
  {
    ...
    label: "Faculties",
    children: [
      { href: "/faculty-of-engineering", label: "Faculty of Engineering" },
      { href: "/faculty-of-life-science", label: "Faculty of Life Science" },
      { href: "/faculty-of-science", label: "Faculty of Science" },
      { href: "/faculty-of-business-studies", label: "Faculty of Business Studies" },
      { href: "/faculty-of-social-science", label: "Faculty of Social Science" },
      { href: "/faculty-of-arts", label: "Faculty of Arts" },
      { href: "/faculty-of-veterinary-medicine-and-animal-sciences", label: "Faculty of Veterinary Medicine and Animal Sciences" },
    ]
  },
  {
    href: "#administration",
    label: "Administration and Offices",
    children: [
      { href: "/administration-and-offices", label: "Administration and Offices" },
      { href: "/vice-chancellor", label: "Vice Chancellor" },
      { href: "/pro-vice-chancellor", label: "Pro Vice Chancellor" },
      { href: "/treasurer", label: "Treasurer" },
      { href: "/the-regent-board", label: "The Regent Board" },
      { href: "/registrar-office", label: "Registrar Office" },
      { href: "/academic-council", label: "Academic Council" },
      { href: "/deans", label: "Dean of Faculties" },
      { href: "/chairman-of-the-departments", label: "Chairman of The Departments" },
    ]
  },
  {
    href: "#research",
    label: "Research",
    children: [
      { href: "/research-facilities", label: "Research Facilities" },
      { href: "/research-centers", label: "Research Centers" },
      { href: "/research-labs", label: "Research Labs" },
      { href: "/research-centre", label: "Research Centre" },
      { href: "/research-cell", label: "Research Cell" },
      { href: "https://journal.mbstu.ac.bd/", label: "Journal" },
    ]
  },
  {
    href: "#campus-life",
    label: "Campus Life",
    children: [
      { href: "/campus-life", label: "Student Life" },
      { href: "/residential-halls", label: "Residential Halls" },
      { href: "/central-library", label: "Central Library" },
      { href: "/medical-center", label: "Medical Center" },
      { href: "/bhashani/clubs", label: "Clubs" },
      { href: "/students-welfare-and-counseling", label: "Students' Welfare and Counseling" },
    ]
  },
  {
    href: "#admission",
    label: "Admission",
    children: [
      { href: "/undergraduate-admission", label: "Undergraduate" },
      { href: "/graduate-admission", label: "Graduate" },
      { href: "/other-admission", label: "Others" },
      { href: "/international-students", label: "International Students" },
    ]
  },
  {
    ...
    label: "Notices",
    children: [
      { href: "/category/notices", label: "Notices" },
      { href: "/category/news", label: "News" },
      { href: "/category/events", label: "Events" },
      { href: "/category/tender", label: "Tender" },
    ]
  },
  {
    href: "#contact",
...
const aboutItems: SubMenuProps[] = [
  ...
  },
  {
    ...
    description: "Student and staff health insurance information",
    href: "https://mbstu.ac.bd/health-insurance/"
  },
  {
    title: "Location, Maps and Direction",
    description: "Campus location, maps and directions",
    href: "https://mbstu.ac.bd/location-maps-and-direction/"
  },
  {
    title: "Visit MBSTU",
    description: "Information for visitors and campus tours",
    href: "https://mbstu.ac.bd/visit-mbstu/"
  },
  {
    title: "Contact Us",
...
const academicItems: SubMenuProps[] = [
  ...
  },
  {
    ...
    href: "https://mbstu.ac.bd/cyber-center/"
  },
  {
  ...
  {
    title: "Faculty of Veterinary Medicine and Animal Sciences",
  ...
  {
    title: "Resident",
    description: "On-campus housing and residential facilities",
...
const facultyItems: SubMenuProps[] = [
  {
    title: "Faculty of Engineering",
    description: "Engineering disciplines and programs",
    href: "https://mbstu.ac.bd/faculty-of-engineering/"
...
const administrationItems: SubMenuProps[] = [
  {
  ...
  {
    title: "BNCC",
    description: "Bangladesh National Cadet Corps",
    href: "https://mbstu.ac.bd/bncc/"
  },
  {
    title: "PGD",
    description: "Post Graduate Department",
    href: "https://mbstu.ac.bd/pgd/"
  },
  {
    title: "Students' Welfare and Counseling",
  ...
  {
    title: "Teaching Evaluation Portal",
    description: "Faculty and teaching assessment system",
    href: "https://mbstu.ac.bd/teaching-evaluation-portal/"
  },
  {
    title: "Estate Office",
    description: "Property and estate management",
    href: "https://mbstu.ac.bd/estate-office/"
  },
  {
    title: "Proctor Office",
    description: "Student discipline and welfare",
    href: "https://mbstu.ac.bd/proctor-office/"
  },
  {
    title: "Public Relations and Press Publication Office",
    description: "Media relations and university publications",
    href: "https://mbstu.ac.bd/public-relations/"
  },
  {
    title: "Accounts Office",
    description: "Financial management and accounting",
    href: "https://mbstu.ac.bd/accounts-office/"
  },
  {
    title: "Planning Development and Works Office",
    description: "University planning and development",
    href: "https://mbstu.ac.bd/planning-development/"
  },
  {
    title: "Controller of Examinations Office",
    description: "Examination management and coordination",
    href: "https://mbstu.ac.bd/controller-examinations/"
  },
  {
    title: "Engineering Office",
    description: "Campus engineering and maintenance",
    href: "https://mbstu.ac.bd/engineering-office/"
  },
  {
    title: "Department of Physical Education",
    description: "Sports and physical education programs",
    href: "https://mbstu.ac.bd/physical-education/"
  },
  {
    title: "Transport Office",
    description: "University transportation services",
    href: "https://mbstu.ac.bd/transport-office/"
  },
  {
    title: "Research Center",
    description: "Research facilities and coordination",
    href: "https://mbstu.ac.bd/research-center/"
  },
  {
    title: "Research Cell",
    description: "Research development and support",
    href: "https://mbstu.ac.bd/research-cell/"
  },
  {
    title: "ICT CELL",
    description: "Information and Communication Technology support",
    href: "https://mbstu.ac.bd/ict-cell/"
  },
  {
...
const campusLifeItems: SubMenuProps[] = [
  {
    title: "Student Life",
    description: "Campus activities, clubs and student organizations",
    href: "https://mbstu.ac.bd/campus-life/"
...
const admissionItems: SubMenuProps[] = [
  {
    title: "Undergraduate",
...
const noticesItems: SubMenuProps[] = [
  {
    title: "Notices",
...
const isDepartmentPage = ref<boolean>(false);
</script>
      ...
      <div class="container flex items-center justify-between h-20">
        ...
        <div class="flex items-center space-x-4">
          <div class="flex items-center">
            <img 
                src="/images/university/logo/MBSTU_logo.png" 
                alt="MBSTU Logo" 
        ...
        <nav class="hidden lg:flex">
          <ul class="flex space-x-1">
            ...
            <li class="relative group">
              ...
              <!-- Dropdown content -->
              <div class="absolute -left-24 mt-1 w-[600px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="p-4">
            ...
            <li class="relative group">
              ...
              <!-- Dropdown content -->
              <div class="absolute -left-24 mt-1 w-[900px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="p-4">
                  <div class="grid grid-cols-4 gap-2">
                    <div 
                      v-for="subItem in administrationItems" 
                      :key="subItem.title"
                      class="group/item rounded-lg p-1 hover:bg-[hsl(var(--tertiary-hover))] transition-colors"
                    >
                      <a :href="subItem.href" class="block">
            ...
            <li class="relative group">
              ...
              <!-- Dropdown content -->
              <div class="absolute -left-24 mt-1 w-[500px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="p-4">
                  <div class="grid grid-cols-1 gap-3">
                    <div 
                      v-for="subItem in admissionItems" 
                      :key="subItem.title"
                      class="group/item rounded-lg p-3 hover:bg-[hsl(var(--tertiary-hover))] transition-colors"
                    >
                      <a :href="subItem.href" class="block">
            ...
            <li class="relative group">
              ...
              <!-- Dropdown content -->
              <div class="absolute -left-24 mt-1 w-[400px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="p-4">
                  <div class="grid grid-cols-1 gap-3">
                    <div 
                      v-for="subItem in noticesItems" 
                      :key="subItem.title"
                      class="group/item rounded-lg p-3 hover:bg-[hsl(var(--tertiary-hover))] transition-colors"
                    >
                      <a :href="subItem.href" class="block">
              ...
              <div class="border-t border-gray-200 p-4 bg-[hsl(var(--tertiary-hover))] flex-shrink-0 mobile-footer">
                <div class="text-center">
                  <div class="text-xs text-gray-500 mb-2">
                    © 2025 MBSTU. All rights reserved.
                  </div>

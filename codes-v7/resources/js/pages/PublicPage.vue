<template>
  <PublicLayout :menuItems="menuItems" :siteData="data.siteData">
    <!-- Page Header -->
          ...
          <div class="component-wrapper">
            ...
            <div v-else class="p-8 bg-gray-50 border border-gray-200 rounded-lg text-center">
              <div class="text-gray-400">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Component Not Available</h3>

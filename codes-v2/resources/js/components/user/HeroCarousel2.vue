        ...
        <div class="embla overflow-hidden" ref="emblaRef">
            <div class="embla__container flex">
                <div v-for="slide in slides" :key="slide.id" class="embla__slide relative w-full flex-none">
                    ...
                    <div class="relative h-[600px] w-full overflow-hidden md:h-[700px] lg:h-[800px]">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="mx-auto max-w-7xl px-4 text-center text-white">
                                <div class="mx-auto max-w-5xl">
                                    ...
                                    <div class="mb-4">
                                        <div class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm">
                                    ...
                                    <!-- Subtitle -->
                                    <p class="mb-3 text-sm font-semibold tracking-wide text-blue-100 uppercase md:text-lg">
                                        {{ slide.subtitle }}
                                    </p>

                                    <!-- Main Title -->
                                    <h1 class="mb-6 text-4xl leading-tight font-bold text-shadow-lg md:text-6xl lg:text-7xl">
                                        {{ slide.title }}
                                    </h1>

                                    <!-- Description -->
                                    <p class="mx-auto mb-10 max-w-4xl text-lg leading-relaxed font-light opacity-95 md:text-xl lg:text-2xl">
                                        {{ slide.description }}
                                    </p>
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-4 sm:flex-row">
                                        <a
                                            :href="slide.ctaLink"
                                            class="inline-flex transform items-center rounded-lg border-2 border-transparent bg-[hsl(var(--primary))] px-10 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:border-white/20 hover:bg-[hsl(var(--secondary))] hover:shadow-xl"
                                        >
                                            {{ slide.ctaText }}
                                        ...
                                        <a
                                            v-if="slide.id === 1"
                                            href="/admission"
                                            class="inline-flex items-center rounded-lg border-2 border-white bg-transparent px-8 py-4 text-lg font-semibold text-white transition-all duration-300 hover:bg-white hover:text-black"
                                        >
                                            Admission
                                        </a>
                                    </div>

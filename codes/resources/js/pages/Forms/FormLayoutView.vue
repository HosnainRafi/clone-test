        ...
        <DefaultCard cardTitle="Contact Form">
          <form action="#">
            <div class="p-6.5">
              ...
              <button
                class="flex w-full justify-center rounded bg-primary p-3 font-medium text-white transition hover:bg-primary hover:opacity-80 cursor-pointer"
              >
                Send Message
              </button>
            </div>
          ...
          <form action="#">
            <div class="p-6.5">
              ...
              <div class="mt-5 mb-5.5 flex items-center justify-between">
                ...
                <Link to="/#" class="text-sm text-primary hover:underline"
                  >Forget password?
                </Link>
              </div>
